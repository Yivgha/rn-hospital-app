    ...
    <View style={styles.appointmentItemBox}>
      <View style={styles.infoBlock}>
        <View style={{ flexDirection: "column", width: "50%", gap: 10 }}>
          ...
          <View style={styles.addressBox}>
            <AntDesign name="infocirlceo" size={17} color={Colors.celestial} />
            <Text style={styles.hospitalAddress} textBreakStrategy="simple">
      ...
      <Text style={[styles.textColor, styles.noteColor]}>
        {appointment.attributes.Note.length > 0 && appointment.attributes.Note}
      </Text>
      <View style={{ position: "absolute", right: 15, bottom: 15 }}>
        <TouchableOpacity
          onPress={() => {
            console.log("clicked delete", appointment.id);
